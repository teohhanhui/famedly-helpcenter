...
<Tabs>
  ...
  <ol>
    <li>Um in Windows ein Emoji hinzuzufügen, tippen Sie das <code>windows-logo</code> + <code>.</code> um die Emoji-Tastatur zu öffnen.</li>
  </ol>
    </TabItem>
  ...
  <ol>
    <li>Tippen Sie auf das <b>Emoji-Icon</b> in der Eingabeleiste um das Emoji-Menü zu öffnen.</li>
    <li>Tippen Sie auf ein Emoji um ihn in die Nachricht einzufügen.</li>
  </ol>
  </TabItem>
</Tabs>
