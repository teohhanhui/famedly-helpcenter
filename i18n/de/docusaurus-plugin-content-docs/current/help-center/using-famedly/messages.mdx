...
<Tabs>
  ...
  <ol>
    ...
    <li>Enter a member's name or select a member from the member list. Sie können diesen Schritt wiederholen für jede Person, die Sie in einer Nachricht erwähnen wollen.</li>
  ...
  <ol>
    ...
    <li>Geben Sie den Namen von der Person, die Sie erwähnen wollen ein oder wählen Sie sie aus der Liste aus. You can repeat this step for each person you want to mention in your message.</li>
