...
| Header 1          | Fügen Sie eine Route ein und drücken Sie die Leertaste vor dem Text: # Ihr Text |
...
| -   Bulleted list | Fügen Sie ein Sternchen und ein Leerzeichen vor Ihrem Text ein.                 |
