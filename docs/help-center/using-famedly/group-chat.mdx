...
<Tabs>
  ...
  <ol>
    <li>Click on the <b>+ Button</b> in the top left corner.</li>
  ...
  <ol>
    ...
    <li>Tap the <b>+ Button</b>.</li>
    <li>Tap <b>New Group</b>.</li>
    <li>Enter a group chat name and optionally a group chat description.</li>
    <li>Add members to the group chat.</li>
    <li>Tap the <b>Hook icon</b> in the top right corner to create the group.</li>
  </ol>
  </TabItem>
</Tabs>
...
With a group name, people can find out what the purpose of the group is. With the group description, members can get more information and important general information can be shared. Only administrators of a group can edit the subject or description.
...
<Tabs>
  ...
  <ol>
    ...
    <li>Click the <b>Hook icon</b> in the top right corner of the screen.</li>
...
<Tabs>
  ...
  <ol>
    <li>Click on the <b>three dots</b> in the top right corner of a group's screen to open the group details.</li>
    <li>Click on the <b>Bell icon</b> to mute the group.</li>
  </ol>
  </TabItem>
  <TabItem value="mobile" label="Mobile">
  <ol>
    <li>Tap the header of a group to open the group details.</li>
    <li>Tap the <b>Bell icon</b> to mute the group.</li>
  </ol>
  </TabItem>
</Tabs>
